	...
	<div class="content">
		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-12">
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="settings/roles/role_list.php" class="nav-link">Role </a></li>
					...
					<div class="card-body">
						...
						<div class="page-table-header mb-2">
							<div class="row align-items-center">
								<div class="col">
									<div class="role-table-blk">
										<h3>Role List</h3>
										<div class="role-search-blk">
											...
											<div class="add-group">
												<?php if(has_permission('roles', 'can_add')): ?>
												<a href="#" data-bs-toggle="modal" data-bs-target="#addRoleModal" class="btn btn-primary add-pluss ms-2"><img src="../assets/img/icons/plus.svg" alt=""></a>
												<?php endif; ?>
												<a href="javascript:;" class="btn btn-primary role-refresh ms-2"><img src="../assets/img/icons/re-fresh.svg" alt=""></a>
												<?php if(has_permission('roles', 'can_delete')): ?>
												<a href="javascript:;" id="deleteSelected" class="btn btn-primary role-delete ms-2 disabled"><img src="../assets/img/icons/trash.svg" alt=""></a>
												<?php endif; ?>
						...
						<div class="table-responsive">
							<input type="hidden" id="role_csrf_token" value="<?php echo csrf_token(); ?>">

							<table class="table border-0 custom-table comman-table datatable mb-0" id="role_table">
								<thead>
									<tr>
										<th>
						...
						<div class="row align-items-center px-2 py-2">
							<div class="col-sm mt-2 text-muted" id="role_InfoText" style="font-size:13px;">
								<!-- information inserted dynamically -->
							</div>

							<div class="col-sm-auto">
								<ul class="pagination my-2" id="role_Pagination">
