...
foreach ($result['data'] as &$row) {
    ...
    $row['role_name'] = ucfirst(strtolower($row['role_name']));
...
switch ($type) {
    case 'csv':
        exportCSV($result['data'], "Role.csv");
        break;
    case 'txt':
        exportTXT($result['data'], "Role.txt");
        break;
    case 'pdf':
        exportPDF($result['data'], "Role.pdf");
        break;
    case 'xlsx':
        exportXLSX($result['data'], "Role.xlsx");
        break;
    default:
