                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-block local-forms cal-icon">
                                                ...
                                                <input id="license_issue_date" name="license_issue_date" class="form-control datetimepicker" type="text" placeholder="DD/MM/YYYY">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-block local-forms cal-icon">
                                                ...
                                                <input id="license_expiry_date" name="license_expiry_date" class="form-control datetimepicker" type="text" placeholder="DD/MM/YYYY">
