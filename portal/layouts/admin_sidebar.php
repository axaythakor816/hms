            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								<li><a class="nav-link active" href="home.php" >Admin Dashboard</a></li>
								</ul>
						</li>
						<li class="submenu">
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a href="patients/add-patient.php" class="nav-link">Add Patients</a></li>
					...
					<div class="logout-btn">
						<a href="dashboard.php?action=logout" ><span class="menu-side"><img src="../assets/img/icons/logout.svg" alt=""></span> <span>Logout</span></a>
					</div>
                </div>
            </div>
        </div>