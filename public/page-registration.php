...
<div class="wrapper">
    ...
    <section class="ulockd-registration bgc-snowshade2" style="padding:80px 0;">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center">
                    <div class="ulockd-main-title">
                        <h2><span class="text-thm">User</span> Registration</h2>
                        <div class="mt-separator"></div>
                        <p class="text-muted">Create an account to manage your appointments and health records.</p>
                    </div>
                </div>
            </div>
