			...
			<div class="row">
				<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-3">
					<div class="about-widget-footer">
    					<img alt="" src="assets/images/footer-logo.png" class="ulockd-footer-log">
    					...
    					<p class="ulockd-ftr-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam quis assumenda adipisci, quasi perferendis id.</p>
						...
						<div class="ulockd-media-box">
							<div class="media">
							    <div class="media-left pull-left">
								    <a href="#">
								    	<img class="media-object" src="assets/images/blog/s1.jpg" alt="s1.jpg">
								    </a>
							    </div>
							...
							<div class="media">
							    <div class="media-left pull-left">
								    <a href="#">
								    	<img class="media-object" src="assets/images/blog/s2.jpg" alt="s2.jpg">
								    </a>
							    </div>
							  	<div class="media-body">
									<a href="#" class="post-date">21 January, 2017</a>
							...
							<div class="media">
							    <div class="media-left pull-left">
								    <a href="#">
								    	<img class="media-object" src="assets/images/blog/s3.jpg" alt="s3.jpg">
								    </a>
							    </div>
							  	<div class="media-body">
									<a href="#" class="post-date">21 January, 2017</a>
				...
				<div class="col-xxs-12 col-xs-6 col-sm-6 col-md-4">
					<div class="flickr-widget">
						...
						<ul class="list-inline">
							<li>
								<div class="thumb">
									<img alt="flckr1.jpg" src="assets/images/gallery/flckr1.jpg" class="img-responsive img-whp">
									<div class="overlay">
							...
							<li>
								<div class="thumb">
									<img alt="" src="assets/images/gallery/flckr2.jpg" class="img-responsive img-whp">
									<div class="overlay">
										<span class="flaticon-add"></span>
									</div>
								</div>
							...
							<li>
								<div class="thumb">
									<img alt="" src="assets/images/gallery/flckr3.jpg" class="img-responsive img-whp">
									<div class="overlay">
										<span class="flaticon-add"></span>
									</div>
								</div>
							...
							<li>
								<div class="thumb">
									<img alt="" src="assets/images/gallery/flckr4.jpg" class="img-responsive img-whp">
									<div class="overlay">
										<span class="flaticon-add"></span>
									</div>
								</div>
							...
							<li>
								<div class="thumb">
									<img alt="" src="assets/images/gallery/flckr5.jpg" class="img-responsive img-whp">
									<div class="overlay">
										<span class="flaticon-add"></span>
									</div>
								</div>
							...
							<li>
								<div class="thumb">
									<img alt="" src="assets/images/gallery/flckr6.jpg" class="img-responsive img-whp">
									<div class="overlay">
										<span class="flaticon-add"></span>
									</div>
								</div>
							...
							<li>
								<div class="thumb">
									<img alt="" src="assets/images/gallery/flckr7.jpg" class="img-responsive img-whp">
									<div class="overlay">
										<span class="flaticon-add"></span>
									</div>
								</div>
							...
							<li>
								<div class="thumb">
									<img alt="" src="assets/images/gallery/flckr8.jpg" class="img-responsive img-whp">
									<div class="overlay">
										<span class="flaticon-add"></span>
									</div>
								</div>
