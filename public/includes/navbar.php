		                ...
		                <ul>
		                    <li class="dropdown">
		                        ...
		                        <ul class="dropdown-menu cart-list">
		                            <li>
		                                <a href="#" class="photo"><img src="assets/images/shop/s1.jpg" class="cart-thumb" alt="s1.jpg" /></a>
		                                <h6><a href="#">Delica omtantur </a></h6>
		                                <p>2x - <span class="price">$99.99</span></p>
		                            </li>
		                            <li>
		                                <a href="#" class="photo"><img src="assets/images/shop/s2.jpg" class="cart-thumb" alt="s2.jpg" /></a>
		                                <h6><a href="#">Omnes ocurreret</a></h6>
		                                <p>1x - <span class="price">$33.33</span></p>
		                            </li>
		                            <li>
		                                <a href="#" class="photo"><img src="assets/images/shop/s3.jpg" class="cart-thumb" alt="s3.jpg" /></a>
			        ...
			        <div class="side bgc-thm">
			            ...
			            <div class="widget">
			                ...
			                <ul class="link">
			                    ...
			                    <li><img title="Facebook Feed With Client File" class="img-responsive ulockd-mt10" src="assets/images/resource/image3.png" alt="image3.png"></li>
			                </ul>
			            </div>
			        </div>
			        <!-- End Side Menu -->
